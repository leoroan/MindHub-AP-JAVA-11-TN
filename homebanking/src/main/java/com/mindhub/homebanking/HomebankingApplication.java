...
public class HomebankingApplication {
    ...
    public CommandLineRunner initData(ClientRepository clientRepository,
        ...
        return (args) -> {
            ...
            Transaction t1 = new Transaction(TransactionType.CREDIT, 1000, "deposit in own account", now, true);
            Transaction t2 = new Transaction(TransactionType.DEBIT, -100, "purchase in store", then, true);
            ...
            Transaction t3 = new Transaction(TransactionType.CREDIT, 9999, "lottery jackpot!", soon, true);
            Transaction t4 = new Transaction(TransactionType.DEBIT, -9998, "just been hacked", later, true);
